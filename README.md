...
総務省「住宅・土地統計調査」によれば、全国の空き家数は、過去30年（1988年～2018年）で394万戸から849万戸となり、２倍以上増加している。
...
**各市区町村の空き家率CSVデータを形成する工程の負担が大きい**

・住宅・土地統計調査に空き家率そのものの指標が用意されていないので自分で算出しなければいけない 
・市区町村の廃統合に伴ってスプレッドシート上の市区町村の項目を付け足したり、途中でデータが無くなるのでデータの欠損が発生することになる

**CSVに紐付いた元データは存在しているが、Mapbox Studioに読み込んだ際に何ら　かの原因でデータの可視化ができない市区町村がある**

最初からデータが無い市区町村はコロプレスの塗りつぶしの処理がされていない表示になるが、このケースでは黒い塗りつぶしとなってしまい、原因の特定ができない状態。



https://user-images.githubusercontent.com/62165727/152567849-f419ed34-a1b4-4fff-9906-60f7f7584b75.mov
...
なぜかズームレベルの設定のミニマムの既定値が10からとなっていて、各都県全体が入るズームレベルにすると、レイヤーが全て消えてしまう。Mapbox Studioでズームレベルを変更する手段が今の所不明。

この問題とデータ可視化ができない問題はユーザーが快適にマップを見るのに致命的な状態。
